...
/**
 * Parses a duration string (e.g., "1h", "30m", "1.5h", "2h 30m") to hours
 * @param duration Duration string like "1h", "30m", "1.5h", "2h 30m"
 * @returns Number of hours (as decimal, e.g., 0.5 for 30 minutes)
 */
