...
const MentorOnboarding: React.FC<MentorOnboardingProps> = ({
  ...
  const getStoredFormData = () => {
    ...
    const stored = localStorage.getItem(
      `mentorOnboarding_${currentUser?.id || "default"}`,
    );
    if (stored) {
      try {
  ...
  const [formData, setFormData] = useState({
    ...
    skills:
      (storedData?.skills?.length ? storedData.skills : currentUser?.skills) ??
      ([] as string[]),
  ...
  useEffect(() => {
    if (typeof window !== "undefined" && currentUser?.id) {
      localStorage.setItem(
        `mentorOnboarding_${currentUser.id}`,
        JSON.stringify({
          ...formData,
          customFieldData,
        }),
      ...
      <div className="flex items-center justify-center space-x-2 mb-8">
        {Array.from({ length: formSteps }, (_, i) => i + 1).map((s) => (
          <React.Fragment key={s}>
            ...
            {s < formSteps && (
              <div
                className={`h-1 w-12 rounded-full ${step > s ? "bg-emerald-600" : "bg-slate-200"}`}
              ></div>
            )}
          </React.Fragment>
        ))}
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-slate-500 dark:text-slate-400">
            Let's set up your profile to help mentees find you.
          </p>
        </div>
          ...
          <div className="space-y-6 animate-in slide-in-from-right-4 fade-in duration-300">
            <div className={CARD_CLASS}>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2 flex items-center">
                <User className="w-6 h-6 mr-2 text-emerald-600" /> Basic
                Information
              </h2>
        ...
        {step === 2 && (
          <div className="space-y-6 animate-in slide-in-from-right-4 fade-in duration-300">
            <div className={CARD_CLASS}>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2 flex items-center">
                <Briefcase className="w-6 h-6 mr-2 text-emerald-600" /> Skills &
                Expertise
              </h2>
              <p className="text-slate-500 dark:text-slate-400 mb-8">
        ...
        {step === 3 && (
          <div className="space-y-6 animate-in slide-in-from-right-4 fade-in duration-300">
            <div className={CARD_CLASS}>
              <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-2 flex items-center">
                <MessageSquare className="w-6 h-6 mr-2 text-emerald-600" /> Your
                Story
              </h2>
              <p className="text-slate-500 dark:text-slate-400 mb-8">
                Help mentees understand who you are and what you can offer.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFormData({ ...formData, maxMentees: e.target.value })
                    }
                    className={INPUT_CLASS}
                  >
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-emerald-700 dark:text-emerald-400">
                      Once you complete onboarding, your profile will be visible
                      to mentees. You'll be notified when someone requests
                      mentorship.
                    </p>
                  </div>
                </div>
            ...
            <div className="flex justify-between pt-4">
              ...
              <button
                onClick={() =>
                  programSettings ? setStep(4) : handleComplete()
                }
            ...
            <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-xl p-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-sm text-emerald-700 dark:text-emerald-400">
                    Once you complete these fields, your profile will be visible
                    to mentees. You'll be notified when someone requests
                    mentorship.
                  </p>
                </div>
          ...
          <div className="space-y-6 animate-in slide-in-from-right-4 fade-in duration-300">
            <div className={CARD_CLASS + " text-center"}>
              ...
              <div className="bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 rounded-xl p-6 mb-8 text-left">
                ...
                <ul className="space-y-3 text-sm text-emerald-800 dark:text-emerald-300">
                  <li className="flex items-start">
                    ...
                    <span>
                      You'll receive notifications when mentees request
                      mentorship with you
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 mr-2 mt-0.5 shrink-0 text-emerald-600" />
                    <span>
                      Admins may match you with mentees based on your skills and
                      availability
                    </span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="w-5 h-5 mr-2 mt-0.5 shrink-0 text-emerald-600" />
                    <span>
                      Your profile will appear in mentor searches and matching
                      suggestions
                    </span>
                  </li>
                </ul>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                <div className="bg-slate-50 dark:bg-slate-800 rounded-lg p-5 border border-slate-200 dark:border-slate-700">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    Join the Mentors Circle to chat with other mentors and share
                    experiences.
                  </p>
                </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-800 rounded-lg p-5 border border-slate-200 dark:border-slate-700">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    Browse articles and guides to help you become an even better
                    mentor.
                  </p>
                </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-800 rounded-lg p-5 border border-slate-200 dark:border-slate-700">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    Check your notifications regularly for mentorship requests
                    and updates.
                  </p>
                </div>
                ...
                <div className="bg-slate-50 dark:bg-slate-800 rounded-lg p-5 border border-slate-200 dark:border-slate-700">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">
                    Once matched, use the calendar to schedule sessions with
                    your mentees.
                  </p>
                </div>
              </div>
              ...
              <button
                ...
                className={
                  BUTTON_PRIMARY +
                  " px-8 py-3 text-base shadow-lg w-full md:w-auto"
                }
              >
