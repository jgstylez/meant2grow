...
/** Cropper for organization logos - uses rectangular crop with 2:1 aspect ratio. */
export const LogoCropperModal: React.FC<LogoCropperModalProps> = ({
  ...
  return (
    <div
      ...
      role="dialog"
      aria-modal="true"
      aria-labelledby="logo-crop-modal-title"
    ...
    >
      <div className="relative w-full max-w-md overflow-hidden rounded-xl bg-white dark:bg-slate-900 shadow-xl" onClick={(e) => e.stopPropagation()}>
        <div className="flex items-center justify-between border-b border-slate-200 dark:border-slate-700 px-4 py-3">
          <h2 id="logo-crop-modal-title" className="text-base font-semibold text-slate-900 dark:text-slate-100">
            Crop logo
          </h2>
          <button
            type="button"
